  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4">
      <div className="glass-card bg-neutral-900 rounded-2xl p-8 w-full max-w-sm border border-neutral-800">
        ...
        <p className="text-neutral-400 text-sm text-center mt-1 mb-6">Join to comment and react</p>
        
        {success ? (
          <div className="bg-neutral-800 border border-pink-400/50 rounded-lg p-4 text-center">
            <p className="text-neutral-200">Check your email for confirmation!</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <label className="text-sm font-medium text-neutral-400">Instagram (optional)</label>
              </div>
              <input type="text" placeholder="@username" value={instagram} onChange={(e) => setInstagram(e.target.value)} className="bg-neutral-800 border border-neutral-700 focus:border-pink-400 focus:outline-none rounded-lg px-4 py-2.5 w-full text-neutral-200" />
            </div>
